  ...
  Future<void> _sendMessage(dynamic auth) async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _messages.add(
            ChatMessage(text: _sanitizeAiResponse(answer), isUser: false),
          );
          _isLoading = false;
        });
      }
      ...
      child: Column(
        ...
        children: [
          InkWell(
            ...
            onTap: () {
              setState(() {
                _showFileSelector = !_showFileSelector;
              });
            },
            child: Padding(
                ...
                children: [
                      ...
                      children: [
                        ...
                        Text(
                          _selectedFileIds.isEmpty
                              ? 'Dang hoi tren tat ca file'
                              : 'Da chon ${selectedFiles.length} file',
                          style: theme.textTheme.bodySmall?.copyWith(
                            color: colorScheme.onSurfaceVariant,
                          ),
                        ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          _showFileSelector ? 'Thu gon' : 'Chon file',
          ...
          AnimatedCrossFade(
            firstChild: Text(
              'Mo rong de chon pham vi file cu the truoc khi hoi AI.',
              style: theme.textTheme.bodySmall?.copyWith(
                color: colorScheme.onSurfaceVariant,
              ),
            ),
            ...
            crossFadeState: _showFileSelector
