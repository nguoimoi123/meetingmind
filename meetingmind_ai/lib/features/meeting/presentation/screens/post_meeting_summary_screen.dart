...
import 'package:meetingmind_ai/features/meeting/presentation/screens/meeting_chat_screen.dart'; // Import màn hình Chat
...
import 'package:meetingmind_ai/features/meeting/logic/post_meeting_summary_logic.dart';
import 'package:meetingmind_ai/features/meeting/presentation/widgets/summary_cards.dart';
...
class _PostMeetingSummaryScreenState extends State<PostMeetingSummaryScreen> {
  ...
  Future<void> _loadMeetingMeta() async {
    ...
    try {
      ...
      final speakerIds = PostMeetingSummaryLogic.extractSpeakerIds(summary);
      final allSpeakerIds = {
        ...speakerIds,
        ...speakerNames.keys,
      };
  ...
  Future<void> _exportReportDocx() async {
    ...
    if (folders.isNotEmpty) {
      ...
      if (selected != null) {
        final content = PostMeetingSummaryLogic.buildReportContent(summary);
        try {
        ...
        child: Column(
          ...
          children: [
            ...
            SummaryContentCard(
              ...
              backgroundColor: _vibrantBlue.withOpacity(0.05),
            ),
            ...
            Text('Việc cần làm',
                style: theme.textTheme.titleLarge?.copyWith(
                    fontWeight: FontWeight.bold, color: colorScheme.onSurface)),
            const SizedBox(height: 12),
            SummaryActionListCard(
              items: summary!.actionItems,
              icon: Icons.check_circle_rounded,
              iconColor: _vibrantGreen,
              backgroundColor: _vibrantGreen.withOpacity(0.05),
            ),
            ...
            if (PostMeetingSummaryLogic.hasScheduleHints(summary)) ...[
              const SizedBox(height: 12),
              SizedBox(
                width: double.infinity,
                height: 50,
                child: ElevatedButton.icon(
                  onPressed: () {
                    final suggestion =
                        PostMeetingSummaryLogic.buildScheduleSuggestion(summary);
                    context.push(
                      '/app/calendar/new',
                      extra: suggestion,
                    );
            ...
            SummaryActionListCard(
              ...
              backgroundColor: _vibrantOrange.withOpacity(0.05),
            ),
